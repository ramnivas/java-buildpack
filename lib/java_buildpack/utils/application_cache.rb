...
require 'java_buildpack/utils/download_cache'

module JavaBuildpack

  # An extension of {JavaBuildpack::DownloadCache} that is configured to use the application cache.  The application
